...
const singleResultSchema = require("./dpp_result_schema.js");
...
const studentTestStatusSch = new mongoose.Schema(
  ...
  {strict: false,minimize:false,timestamps:true,collection:"dpp_student_test_status"}
);

studentTestStatusSch.index({ test: 1, student: 1,attempt_number:1,batch:1 }, { unique: true });
module.exports = mongoose.model("dpp_student_test_status", studentTestStatusSch);